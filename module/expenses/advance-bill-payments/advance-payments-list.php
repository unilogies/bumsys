        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title"><?= __("Advance Bills Payment List"); ?></h3>
              ...
              <table id="dataTableWithAjaxExtend" class="table table-striped table-hover" width="100%">
                ...
                <tfoot>
                  <tr>
                    ...
                    <th><?= __("Reference"); ?></th>
                    <th>
                        <select id="advancePaymentEmpList" class="form-control select2Ajax" select2-ajax-url="<?php echo full_website_address() ?>/info/?module=select2&page=employeeList" style="width: 100%;" required>
  ...
  <script>
    var DataTableAjaxPostUrl = "<?php echo full_website_address(); ?>/xhr/?module=expenses&page=advancePaymentList";
  </script>
