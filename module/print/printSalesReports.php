...
<?php 
   ...
   $selectSales = easySelectD("
     select customer_id, customer_name, product_id, product_code, product_name, sum(sale_item_quantity) as sale_item_quantity_sum, sum(sale_item_subtotal) as sale_item_subtotal_sum from {$table_prefix}sale_items as sale_item
