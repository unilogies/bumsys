...
if(isset($_GET['page']) and $_GET['page'] == "editProductEdition") {
    ...
    ?>
      <div class="box-body">
        ...
        <input type="hidden" name="edition_id" value="<?php echo $_GET['id']; ?>">
...
if(isset($_GET['page']) and $_GET['page'] == "editProductAttribute") {
    ...
    ?>
      <div class="box-body">
        ...
        <input type="hidden" name="pa_id" value="<?php echo $_GET["id"]; ?>">
...
if(isset($_GET['page']) and $_GET['page'] == "editProductVariation") {
    ...
    ?>
      <div class="box-body">
        ...
        <input type="hidden" name="pv_id" value="<?php echo $_GET["id"]; ?>">
...
if(isset($_GET['page']) and $_GET['page'] == "editProductGeneric") {
    ...
    ?>
      <div class="box-body">
        ...
        <input type="hidden" name="generic_id" value="<?php echo $_GET["id"]; ?>">
