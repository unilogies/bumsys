            ...
            <div class="col-xs-6">
                <div class="box box-info">
                    <div class="box-header">
                        ...
                        <div class="printButtonPosition"><a class="" target="_blank" href='<?php echo full_website_address(); ?>/print/?page=allCustomerOfThisProduct&pid=<?php echo $_GET["pid"]; ?>'><?= __("View All"); ?></a></div>
                    </div>
                    <div class="box-body">
