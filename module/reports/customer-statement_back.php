                        ...
                        <form id="customerStatementReport" action="">
                            <div class="row">
                                <div class="col-md-5 form-group">
                                    <label for="customerStatementDateRange"><?= __("Date range"); ?></label>
                                    <input type="text" name="customerStatementDateRange" id="customerStatementDateRange" class="form-control dateRangePickerPreDefined" value="<?= date("Y-01-01") . " - " . date("Y-12-31"); ?>" autoComplete="off" required>
                                </div>
                                <div class="col-md-5 form-group">
