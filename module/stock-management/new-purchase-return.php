    ...
    <section class="content container-fluid">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <!-- Form start -->
                <form method="post" id="inlineForm" role="form" action="<?php echo full_website_address(); ?>/xhr/?module=stock-management&page=newPurchaseReturn" enctype="multipart/form-data">
                            ...
                            <div class="modal-dialog ">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title"><?= __("Finalize Purchase Return"); ?></h4>
                                    </div>
                                    <div class="modal-body">
