  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <?php 
        ...
        if(isset($_GET["action"]) and $_GET["action"] == "addPurchaseReturn") {
          // Show a success msg
          echo _s("Purchase return has been successfully added.");
        }
    ...
    <section class="content-header">
      <h1>
        ...
        <a href="<?php echo full_website_address(); ?>/stock-management/new-purchase-return/" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> <?= __("Add New"); ?></a>
      </h1>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-header">
              <h3 class="box-title"><?= __("Purchase Return List"); ?></h3>
  ...
  <script>
    ...
    var DataTableAjaxPostUrl = "<?php echo full_website_address(); ?>/xhr/?module=stock-management&page=productPurchaseReturnList";
