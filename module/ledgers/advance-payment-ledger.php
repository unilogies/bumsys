        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-body">
              ...
              <form id="advancePaymentLedgerForm" action="">
                <div class="row">
                  <div class="col-md-5 form-group">
                      <label for="advancePaymentLedgerDateRange"><?= __("Date range"); ?></label>
                      <input type="text" name="advancePaymentLedgerDateRange" id="advancePaymentLedgerDateRange" class="form-control dateRangePickerPreDefined" autoComplete="off" required>
                  </div>
                  <div class="col-md-5 form-group">
  ...
  <script>
    ...
    var DataTableAjaxPostUrl = "<?php echo full_website_address(); ?>/xhr/?module=ledgers&page=advancePaymentLedger";
