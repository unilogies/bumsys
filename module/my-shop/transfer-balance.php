  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?= __("Transfers"); ?>
        <a data-toggle="modal" data-target="#modalDefault" href="<?php echo full_website_address(); ?>/xhr/?tooltip=true&select2=true&module=my-shop&page=myShopNewTransferBalance" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> <?= __("Add"); ?></a>
      </h1>
      <ol class="breadcrumb">
  ...
  <!-- /.content-wrapper -->
  <script>
    var DataTableAjaxPostUrl = "<?php echo full_website_address(); ?>/xhr/?module=my-shop&page=transferBalanceList";
  </script>
