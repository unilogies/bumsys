  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a data-toggle="modal" data-target="#modalDefault" href="<?php echo full_website_address(); ?>/xhr/?tooltip=true&select2=true&module=my-shop&page=shopAdvanceCollection" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Advance</a>
      </h1>
      <ol class="breadcrumb">
  ...
  <script>
    ...
    var DataTableAjaxPostUrl = "<?php echo full_website_address(); ?>/xhr/?module=my-shop&page=shopAdvanceCollectionList";
  </script>
