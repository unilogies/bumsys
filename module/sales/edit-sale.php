                        ...
                        <div class="box box-primary" style="margin-bottom: 0;">
                            ...
                            <div class="box-body">
                                ...
                                <div title="Select Customer" data-toggle="tooltip" class="form-group">
                                    <select style="width:100%" name="customers" id="customers" class="form-control select2Ajax" select2-create-new-url="<?php echo full_website_address(); ?>/xhr/?tooltip=true&module=peoples&page=newCustomer" select2-minimum-input-length="1" select2-ajax-url="<?php echo full_website_address(); ?>/info/?module=select2&page=customerList">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <div title="Search Product" data-toggle="tooltip">
                                            <select name="selectPosProduct" id="selectPosProduct" class="form-control pull-left select2Ajax" select2-minimum-input-length="1" select2-ajax-url="<?php echo full_website_address() ?>/info/?module=select2&page=productListForPos&wid=<?php echo $_SESSION["wid"]; ?>" style="width: 100%;">
                            ...
                            <div class="box-body">
                                ...
                                <table style="width: 100%; background: #ecf0f5;" id="posCalculationTable">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= __("Tariff & Charges"); ?> <a data-toggle="modal" data-target="#salesTariffCharges" href="#"> <i class="fa fa-edit"></i>
                                                </a> </td>
                                            <td class="text-right totalTariffChargesAmount">(+) <?php echo $sale["sales_tariff_charges"]; ?></td>
                                            <td><?= __("Discount"); ?> <a data-toggle="modal" data-target="#orderDiscount" href="#"> <i class="fa fa-edit"></i> </a> </td>
                                ...
                                <div class="post-action">
                                    ...
                                    <div style="float: left;" class="btn-group">
                                        <button type="button" onClick="BMS.POS.clearScreen()" class="btn btn-danger btn-block btn-flat"><?= __("Cancel"); ?></button>
                                    </div>

                                    <div style="float: right;" class="btn-group">
                                        <button data-toggle="modal" data-target="#payment" type="button" class="btn btn-success btn-block btn-flat"><i class="fa fa-money"></i>
                                            <?= __("Paymnet"); ?></button>
                                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="productSaleItemPrice" class="form-control" value="" onclick="this.select()">
                                        </div>
                                        <div class="form-group">
                                            <label for="productSaleItemDiscount"><?= __("Discount"); ?></label>
                                            <input type="text" id="productSaleItemDiscount" class="form-control" value="" onclick="this.select()">
                                        </div>
                                        <div class="form-group">
                                            <label for="productSaleItemPacket"><?= __("Packet"); ?></label>
                                            <input type="text" id="productSaleItemPacket" class="form-control" value="" onclick="this.select()">
                                        </div>
                                        <div class="form-group">
                                            <label for="productSaleItemDetails"><?= __("Details"); ?></label>
                                            <textarea id="productSaleItemDetails" rows="3" class="form-control" placeholder="Eg: Product EMI or serial"></textarea>
                                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div style="padding-left: 0 !important;" class="col-sm-10">
                                            ...
                                            <table id="finalizeSale" class="table table-bordered table-striped table-hover">
                                                <tbody>
                                                    <tr>
                                                        <td colspan="2">
                                                            <input type="radio" name="saleOptions" value="wastage" id="salesIsWastage">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><?= __("Packet(s)"); ?></span>
                                                                ...
                                                                <input type="text" name="packetShippingRate" id="packetShippingRate" onclick="this.select()" value="75" class="form-control">
                                                                <span class="input-group-addon"><?= __("Tk. Rate"); ?></span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="col-md-3">
                                                            <input type="number" name="shippingCharge" id="shippingCharge" onclick="this.select()" value="<?php echo $sale["sales_shipping"]; ?>" class="form-control" step="any">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align: middle;" class="text-right" colspan="3"><strong><?= __("Adjust Amount"); ?></strong></td>
                                                        <td class="text-right">
                                                            <input type="number" name="adjustAmount" id="adjustAmount" class="form-control" value="<?php echo $sale["sales_adjustment"]; ?>" step="any">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="col-sm-2 text-center">
                                            ...
                                            <h3 style="font-size: 20px; font-weight: bold; margin: 0; padding: 0 0 2px 0;">
                                                <?= __("Quick Cash"); ?></h3>

                                            <div style="display: block;" class="btn-group btn-group-vertical">
                                                <button type="button" class="btn btn-lg btn-info quick-cash" id="quickPayableAmount"><?php echo $sale["sales_grand_total"]; ?></button>
                                                <button type="button" class="btn btn-md btn-warning quick-cash">10</button>
                                                <button type="button" class="btn btn-md btn-warning quick-cash">50</button>
                                                <button type="button" class="btn btn-md btn-warning quick-cash">100</button>
                                                <button type="button" class="btn btn-md btn-warning quick-cash">500</button>
                                                <button type="button" class="btn btn-md btn-warning quick-cash">1000</button>
                                                <button type="button" class="btn btn-md btn-warning quick-cash">5000</button>
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="salesNote" id="salesNote" rows="4" class="form-control"><?php echo $sale["sales_note"]; ?></textarea>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="salesShipingAddress"><?php echo __("Shipping Address:"); ?></label>
                                            <textarea name="salesShipingAddress" id="salesShipingAddress" rows="4" class="form-control"><?php echo $sale["sales_shipping_address"]; ?></textarea>
                                        </div>
