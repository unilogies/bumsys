                        ...
                        <table id="dataTableWithAjaxExtend" class="table table-striped table-hover" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Order Date</th>
                                    <th type="datePicker" where-to-update="<?php echo full_website_address(); ?>/info/?module=data&page=updateInLine&tab=sales&p=sales_&f=delivery_date&t=id" class="sort text-center"><?= __("Delivery Date"); ?></th>
                                    <th class="defaultOrder text-center"><?= __("Reference"); ?></th>
                                    <th type="select2" data-source="<?php echo full_website_address(); ?>/info/?module=select2&page=customerList" where-to-update="<?php echo full_website_address(); ?>/info/?module=data&page=updateInLine&tab=sales&p=sales_&f=customer_id&t=id" style="sort width: 180px!important;" class="text-center"><?= __("Customer"); ?>
                                    </th>
                                    ...
                                    <th type="select" data-options="Order Placed,In Production,Processing,Hold,Delivered,Cancelled" where-to-update="<?php echo full_website_address(); ?>/xhr/?module=my-shop&page=changeSaleStatus" class="sort text-center no-print"><?= __("Status"); ?>
                                    </th>
...
<script>
    ...
    var DataTableAjaxPostUrl = "<?php echo full_website_address(); ?>/xhr/?module=production&page=orderList";
