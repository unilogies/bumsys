                  ...
                  <form id="posSale" action="#">
                      <div class="box box-info" style="margin-bottom: 0;">
                          ...
                          <div class="box-body">
                                ...
                                <div class="row">
                                    <div title="Select Customer" data-toggle="tooltip" class="form-group col-md-6">
                                        <select style="width:100%" name="customers" id="customers" class="form-control select2Ajax"
                                            ...
                                            select2-ajax-url="<?php echo full_website_address(); ?>/info/?module=select2&page=customerList" required>
                                            <option value="">Select Customer...</option>
                                        </select>
                                        <input type="hidden" name="customersId" id="customersId" value="">
                                    </div>
                                    <div title="Select Warehouse" data-toggle="tooltip" class="form-group col-md-6">
                                  ...
                                  <div class="input-group">
                                        ...
                                        <div title="Search Product" data-toggle="tooltip">
                                            <select name="selectPosProduct" id="selectPosProduct"
                                                ...
                                                select2-ajax-url="<?php echo full_website_address() ?>/info/?module=select2&page=productList"
                                                style="width: 100%;">
                                                <option value=""><?php echo __("Search Product"); ?>....</option>
                                            </select>
                                        </div>
                          ...
                          <div style="width: 820px;" class="modal-dialog ">
                              <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title"><?php echo __("Finalize Order"); ?></h4>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <div style="padding-left: 0 !important;" class="col-sm-10">
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label for="orderDate"><?php echo __("Order Date:"); ?></label>
                                                    <input type="text" name="orderDate" value="<?php echo date("Y-m-d"); ?>" id="orderDate" class="form-control datePicker" required>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="salesDate"><?php echo __("Estimated Delivery Date:"); ?></label>
                                                    <input type="text" name="salesDate" value="<?php echo date("Y-m-d"); ?>" id="salesDate" class="form-control datePicker" required>
                                                </div>
                                                
                                            </div>
                                            <input type="hidden" name="salesStatus" value="Order Placed">
                                        ...
                                        <div class="form-group">
                                            <label for="salesNote"><?php echo __("Order note:"); ?></label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button name="posAction" value="sale_is_confirmed" type="submit" class="posSubmit btn btn-success"><i class="fa fa-check-circle"></i> <?php echo __("Confirm Order"); ?></button>
                                    </div>
                              </div>
                              <!-- /.modal-content -->
                          </div>
  ...
  <script>
        ...
        var saleOrderPageUrl = window.location.href;
