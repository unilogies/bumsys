...
<div class="content-wrapper">
    ...
    if(isset($_GET["action"]) and $_GET["action"] == "addSpecimenCopy" and !empty($_POST)) {
        ...
        if( isset($insertSC["status"]) and $insertSC["status"] === "success" ) {
            ...
            foreach($_POST["productID"] as $key => $productId) {
                ...
                easyInsert(
                    ...
                    array (
                        ...
                        "stock_sc_id"           => $insertSC["last_insert_id"],
        ...
        $rdrTo = full_website_address() . "/invoice-print/?autoPrint=true&invoiceType=scpecimenCopy&msg=Successfully Added&id=". $insertSC['last_insert_id'];
        redirect($rdrTo);
    ...
    <section class="content container-fluid">
        <div class="box box-default">
            ...
            <div class="box-header with-border">
                <h3 class="box-title"><?= __("Add Specimen Copy"); ?></h3>
            </div> <!-- box box-default -->

            <div class="box-body">

                <!-- Form start -->
                <form method="post" id="specimenCopyForm" role="form" action="<?php echo full_website_address(); ?>/marketing/add-specimen-copy/?action=addSpecimenCopy" enctype="multipart/form-data">
                        ...
                        <div style="margin-top: 2px;" class="col-md-5">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="input-group data">
                                    ...
                                    <input type="text" name="sctransferDate" id="sctransferDate" value="<?php echo date("Y-m-d"); ?>" class="form-control pull-right datePicker" required>
                                </div>
                            </div>
                            <div class="form-group required">
                            ...
                            <div class="form-group required">
                                ...
                                <input type="hidden" name="scTransferWarehouseId" id="scTransferWarehouseId" value="">
                            </div>
