            ...
            <div class="box-body">
              <table id="dataTableWithAjaxExtend" class="table table-bordered table-striped table-hover" width="100%">
                <thead>
                  <tr>
                    <th></th>
                    <th class="px160"><?= __("Representative"); ?></th>
                    <th class="px160"><?= __("Product"); ?></th>
                    <th><?= __("Edition"); ?></th>
                    ...
                    <th class="no-sort countTotal"><?= __("Dispatch Value"); ?></th>
                    <th class="no-sort countTotal"><?= __("Distribution Value"); ?></th>
                    <th class="no-sort countTotal"><?= __("In Hand Value"); ?></th>
                    <th><?= __("Unit"); ?></th>
                  </tr>
                </thead>
                ...
                <tfoot>
                  <tr>
                    <th></th>
                    <th>
                        <select style="width: 155px;" id="representiveFilter" class="form-control select2Ajax" select2-ajax-url="<?php echo full_website_address() ?>/info/?module=select2&page=employeeListAll" style="width: 100%;" required>
                            <option value=""><?= __("All Representative"); ?>...</option>
                        </select>
                    </th>
                    <th class="no-print">
                        <input style="width: 155px;" type="text" placeholder="<?= __("Select Date"); ?>" id="dateRangeFilter" class="form-control" autocomplete="off">
                    </th>
                    <th>
  ...
  <script>
    ...
    BMS.FUNCTIONS.dateRangePickerPreDefined({selector: "#dateRangeFilter"});
  </script>
