  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a data-toggle="modal" data-target="#modalDefault" href="<?php echo full_website_address(); ?>/xhr/?tooltip=true&select2=true&module=incomes&page=addReceivedPayments" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> <?= __("Add Payments"); ?></a>
      </h1>
      <ol class="breadcrumb">
  ...
  <script>
    var DataTableAjaxPostUrl = "<?php echo full_website_address(); ?>/xhr/?module=incomes&page=receivedPaymentsList";
  </script>
